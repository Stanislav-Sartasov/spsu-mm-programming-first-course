...
namespace ThirdTask.GameDescription
{
	public abstract class Person // Abstract player.
	{
		...
		public abstract void Action(Pad pad);
		public virtual void ApplyTurn(string turn, Pad pad)
		{
			switch (turn)
			{
				case "Hit":
