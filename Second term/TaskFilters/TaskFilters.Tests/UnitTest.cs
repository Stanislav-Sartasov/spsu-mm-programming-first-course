...
namespace TaskFilters.Tests
{
    ...
    public class UnitTest
    {
        ...
        {
            string[] workingString = { "input.bmp", "Gauss3", "outputname.bmp" };
            string[] voidString = { "" };
            Assert.AreEqual(false, TaskFilters.Input.CorrectInput(voidString));
            Assert.AreEqual(true, TaskFilters.Input.CorrectInput(workingString));
